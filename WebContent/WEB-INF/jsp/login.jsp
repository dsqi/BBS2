...
<div class="topNav">
    <div class="wrapper">
        <div class="userNav">
            <ul>
                <li><a href="#" title=""><img src="${pageContext.request.contextPath}/statices/images/icons/topnav/mainWebsite.png" alt="" /><span>首页</span></a></li>
            </ul>
        </div>
        <div class="clear"></div>
    </div>
...
<div class="loginWrapper">
    ...
    <div class="widget">
        <div class="title"><img src="${pageContext.request.contextPath}/statices/images/icons/dark/files.png" alt="" class="titleIcon" /><h6>登录</h6></div>
        <form action="index.html" id="validate" class="form">
            <fieldset>
                ...
                <a>忘记密码</a>
                    ...
                    <input type="submit" value="登录" class="dredB logMeIn" style="margin-right: 20px;"/>
                    <div class="clear"></div>
